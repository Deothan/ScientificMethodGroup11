...
\section{Results}
%text text text!!!    bla bla bla bla bla bla bla bla bla
...
Figure~\ref{fig:Total normalized data distributed in tasks} is a visualization of the total normalized data divided into the four different tasks. These data is calculated based on the weights: Passed=1, critical=0.5, failed=0.01. %beskriv beskriv beskriv!
...
\textbf{Do we have some interesting TTV categories that needs references???.}\\
