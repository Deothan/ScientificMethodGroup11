...
From this experiment we are not able, to generate a conclusion. There doesn't seem to be a relation between the test subjects, and the actual target group, using these approaches.
=======
...
%We need a source for this CFTA
...
% We aim to investigate what the impact of the level of detail in the task description is related to Test-Driven development and the Test-After approach.
